...
const MovieCast = () => {
  ...
  const defaultActorImg = "https://dummyimage.com/200x300/cdcdcd/000.jpg&text=No+image";
      ...
      <ul className={s.castList}>
        {movieCast.map((cast) => (
          <li key={cast.id} className={s.castItem}>
            <img
              src={cast.profile_path ? `https://image.tmdb.org/t/p/w500/${cast.profile_path}` : defaultActorImg}
              alt={cast.name}
