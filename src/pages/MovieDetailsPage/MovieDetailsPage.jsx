...
const MovieDetailsPage = () => {
  ...
  const defaultPosterImg = "https://dummyimage.com/400x600/cdcdcd/000.jpg&text=No+poster";
  useEffect(() => {
  ...
  return (
    <div className={s.movieDetails}>
      ...
      <div className={s.movieInfo}>
        <img
          src={
            movieDetail.poster_path ? `https://image.tmdb.org/t/p/w500/${movieDetail.poster_path}` : defaultPosterImg
          }
